...
public class MovieChoice extends HttpServlet {
    ...
    private Movie giveVerdict (String requestChoice) {
        ...
        if (requestChoice != null) choice = requestChoice;
        switch (choice) {
            case "Bladerunner": name="Bladerunner 2049"; verdict="Four Stars!";break;
            case "Machina": name="Ex Machina"; verdict="Three Stars!";break;
            case "Force": name="The Force Awakens"; verdict="Two Stars!";break;
            case "Jedi": name="The Last Jedi"; verdict="One Star!";break;
            default: name="error"; verdict="error";
